  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto bg-white dark:bg-zinc-950 border-r border-gray-200 dark:border-zinc-800/60">
      ...
      <div className={`p-5 flex items-center ${collapsed ? "justify-center" : "gap-3"}`}>
        <div className="w-10 h-10 rounded-xl bg-red-600/10 dark:bg-red-600/20 flex items-center justify-center shrink-0">
      ...
      {/* Nav */}
      <nav className={`flex-1 ${collapsed ? "p-2" : "p-3"} mt-2 space-y-4 overflow-y-auto`}>
              ...
              {section.items.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`group flex items-center ${collapsed ? "justify-center px-0 py-2.5" : "gap-3 px-3 py-2.5"} rounded-xl text-[13px] font-medium transition-all duration-200 ${
                      isActive
      ...
      {/* Bottom */}
      <div className={`${collapsed ? "p-2" : "p-3"} space-y-0.5`}>
        <Link
          to="/"
          onClick={onNavigate}
          title={collapsed ? "Volver a la tienda" : undefined}
          className={`flex items-center ${collapsed ? "justify-center px-0 py-2.5" : "gap-3 px-3 py-2.5"} rounded-xl text-[13px] text-gray-500 hover:text-zinc-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-zinc-800/60 transition-all duration-200`}
        >
          <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-gray-100 dark:bg-zinc-800/50 shrink-0">
        ...
        <button
          ...
          className={`w-full flex items-center ${collapsed ? "justify-center px-0 py-2.5" : "gap-3 px-3 py-2.5"} rounded-xl text-[13px] text-gray-500 hover:text-zinc-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-zinc-800/60 transition-all duration-200`}
        >
          <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-gray-100 dark:bg-zinc-800/50 shrink-0">
